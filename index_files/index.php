  ...
  <?php include 'index_files/header.php';?>
    ...
    <div class="info">
	  ...
	  <p></p><h3>Contact Information:</h3>
		...
		<ul>
		<li><strong>Address:</strong> 7918 Whitemore Street, Rosemead, CA 91770</li>
		<li><strong>Email:</strong> <em>ychen012 @ </em><var>qq.com</var></li>		
		<li><strong>Office Phone:</strong> (626) 818-0513</li>
		<li><strong>Home Phone:</strong> (626) 818-0513</li>
	...
	<div class="col_100">
      ...
      <div class="copyright">Keep it simplest! Based on <a href="http://cssr.ru/simpliste/">Simpliste</a> template with Blackberry skin.</div>
